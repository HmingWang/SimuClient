...
namespace AsyncService
{
    ...
    class AsyncService
    {
        ...
        //开始连接 客户端模式使用
        public void StartConnect(IPEndPoint remoteEndPoint)
        {

            SocketAsyncEventArgs connectEventArg = new SocketAsyncEventArgs();
            connectEventArg.RemoteEndPoint = remoteEndPoint;
            connectEventArg.Completed += new EventHandler<SocketAsyncEventArgs>(ConnectEventArg_Completed);

            Socket connectSocket = new Socket(remoteEndPoint.AddressFamily, SocketType.Stream, ProtocolType.Tcp);//客户端连接Socket
